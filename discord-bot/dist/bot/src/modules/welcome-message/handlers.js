...
import { rulesChannelLink, data, welcomeChannelId, } from "../../lib/modules/welcome-message/config-io.js";
export async function handleMemberAdd(member) {
    ...
    if (!channel || !channel.isTextBased() || !channel.isSendable()) {
        console.warn(`[welcome-message] Welcome channel ${channelId} is missing or not sendable; skipping.`);
        return;
    }
