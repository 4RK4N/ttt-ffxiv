...
import { CLOSE_CANCEL_PREFIX, CLOSE_CONFIRM_PREFIX, CLOSE_PREFIX, DELETE_CANCEL_PREFIX, DELETE_CONFIRM_PREFIX, DELETE_PREFIX, OPEN_PREFIX, ROLE_ACTION_PREFIX, } from "../../lib/modules/tickets/panel.js";
...
async function handleComponent(interaction) {
    ...
    if (customId.startsWith(ROLE_ACTION_PREFIX)) {
        await handleRoleAction(interaction);
        return;
    }
    ...
    if (customId.startsWith(CLOSE_PREFIX) ||
