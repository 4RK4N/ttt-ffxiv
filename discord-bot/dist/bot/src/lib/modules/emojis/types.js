...
export const TEXT_DEFAULTS = {
    ...
    invalidName: "Invalid emoji name. Use 2–32 characters: letters, numbers, and underscores only.",
    ...
    fileTooLarge: "That image is too large. Discord emojis must be 256 KiB or smaller.",
    notCustomEmoji: "Only custom emojis can be copied. Paste a custom emoji from another server (not a standard unicode emoji).",
    downloadFailed: "Could not download the image. Please try again.",
    botMissingPermission: "I do not have the Manage Emojis and Stickers permission in this server.",
    slotsFull: "This server has no remaining emoji slots. Remove an emoji or increase your boost level.",
