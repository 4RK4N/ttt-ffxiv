...
ALL_SERVICES=(ttt-discord-bot ttt-web-editor ttt-website)

usage() {
  cat >&2 <<EOF
Usage: $0 [-v] [--no-cache] [service ...]

Build and recreate Docker services (default: all three).
...
resolve_service() {
  case "$1" in
    ...
    ttt-web-editor | web | web-editor | editor) echo ttt-web-editor ;;
